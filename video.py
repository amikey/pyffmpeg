...
class VideoFFMpeg(BaseFFMpeg):
    ...
    def extract_audio(self, video_input):
        ...
        # stream with the help of the * tool?
        ...
        # is this the right way to determine extension?
    ...
    def add_logo(self, video_input, video_output,
                 logo, right_corner=False, position=[]):
        ...
        _cmds = ['-i', video_input, '-i', logo, '-filter_complex',
